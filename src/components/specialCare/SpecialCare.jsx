  ...
  return (
    <section id='specialCare'>
      <div className="text-specialCare">
        ...
        <p>Collaboratively administrate empowered markets via plug-and-play networks. <span>Dynamically procrastinate B2C</span> users after installed base benefits. Dramatically visualize customer.</p>
        ...
        <ul>
          <li><RiVerifiedBadgeFill size={20} color='#0FE3AF'/>20+ years of excellence</li>
          <li><RiVerifiedBadgeFill size={20} color='#0FE3AF'/>Professional Experts</li>
        </ul>
